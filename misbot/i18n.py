...
STRINGS: Dict[str, Dict[str, str]] = {
    ...
    "choose_language": {
        ...
        # всех языках сразу: человек должен узнать свой, не зная остальных.
        # Отсюда и одинаковые значения — какой бы язык ни был текущим, показать
        # надо одно и то же.
        RU: "Выберите язык / აირჩიეთ ენა / Choose a language",
        KA: "Выберите язык / აირჩიეთ ენა / Choose a language",
